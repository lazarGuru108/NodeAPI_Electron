...
import TableView from './ProductList/TableView';
        ...
        return (
            <div className="container-fluid" id="product">
                <Collapse  accordion activeKey={[this.state.activeKey]} onChange={(key) => this.callback(key)} expandIconPosition={''} expandIcon={(isActive) => <Icon type={isActive?'plus':'minus'} />}>
                    <Panel className="panelHeader" header="Add New Product" key="1" extra={<Icon type={this.state.activeKey !== '1'?"plus":"minus"}/>}>
                    ...
                    <Panel className="panelHeader" header="Product List" key="3" extra={<Icon type={this.state.activeKey !== '3'?"plus":"minus"}/>}>
