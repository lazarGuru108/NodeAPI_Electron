...
class TableView extends React.Component {
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                dataIndex: 'totalItem',
                width: '15%',
                sorter: (a, b) => parseInt(a.totalItem) > parseInt(b.totalItem),
                editable: false,
            },
            {
                ...
                width: '15%',
                sorter: (a, b) => parseInt(a.totalQuantity) > parseInt(b.totalQuantity),
                editable: false,
            },
            {
                title: 'View',
    ...
    exportPDF = () => {
        ...
        const headers = [["Id", "Name", "Mobile", "Product", "Created At"]];

        const data = this.state.dataSource.map(elt => [elt.id, elt.uname, elt.mobile, elt.product, elt.createdAt]);
